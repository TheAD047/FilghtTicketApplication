...
namespace FilghtTicketApplication.Controllers
{
    public class SeatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("seatID,flightID,seatNum,seatRow")] Seat seat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("seatID,flightID,seatNum,seatRow")] Seat seat)
        {
            if (id != seat.seatID)
            {
                return NotFound();
